       ...
       $s2=$this->db->simple_query('SELECT * FROM ambulance where email="'.$_SESSION['email'].'"');
            ...
            echo '<td> Agency </td>';
                       ...
                       echo '<td>' .$row2["mobno"].'</td>';
                        ...
                        echo '</tr>';
            $s3=$this->db->simple_query('SELECT * FROM ambulance where agency="'.$row2['agency'].'"');
        while(mysqli_fetch_array($s3))
        {
                        echo '<tr>';
                        
                        echo '<td> Homelocation </td>';
                        echo '<td>' .$row2["homelocation"].'</td>';
                        echo '</tr>';
       ...
       <?php   echo ' Name :'.$res1['name'].'<br>'; ?>
        ...
        <div  class="req1"><center>
         ...
         <input type="hidden" name="emailh" class="btn" value="<?php echo $res1['email'] ; ?> " /> 
             ...
             <input type="submit" name="select" class="btn" value="SELECT DRIVER" /> <br><br>
             <input type="submit" name="reject" class="btn" value="DELETE" /> 
             </center>
          </div>
      <?php  echo '</div>';?>
